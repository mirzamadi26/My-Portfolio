      ...
      <Container>
        <Row>
          <Col md={8} className="home-about-description">
            ...
            I am a passionate  <b className="purple">
                  Flutter Developer
                </b> with a deep love for creating intuitive and engaging mobile applications. My journey in programming has led me to specialize in mobile app development, where I enjoy turning innovative ideas into seamless user experiences.
              <br />
              <br></br>
              ...
              Constantly learning and innovating, I strive to push boundaries and deliver meaningful mobile experiences that make a difference.
            </p>
          </Col>
